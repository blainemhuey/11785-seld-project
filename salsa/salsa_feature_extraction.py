...
def compute_scaler(feature_dir: str, audio_format: str) -> None:
    ...
    train_feature_dir = os.path.join(feature_dir)
...
def extract_features(data_config: str = 'salsaconfig.yml',
    ...
    if task in ['feature_scaler', 'feature']:
        for split in splits:
            ...
            audio_dir = os.path.join(cfg['data_dir'], 'foa_dev', dirname)
            # /data/seld2022/foa_dev/dev-train-tau
            feature_dir = os.path.join(cfg['feature_dir'], feature_type, audio_format, feature_description, dirname)
            # /data/seld2022/features/salsa/foa/24000fs_512nfft_300nhop_5cond_9000fmaxdoa/dev-train-tau
